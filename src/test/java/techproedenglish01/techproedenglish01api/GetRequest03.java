...
import static io.restassured.RestAssured.*;//Bunu given method için manuel olarak yaptık.İmport ettik.
 ...
 */
	@Test
	public void get01() {
		Response response = given().when().get("https://restful-booker.herokuapp.com/booking/5");//Sonuç responce objecte depolandı
